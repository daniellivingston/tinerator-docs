...
Your configuration lives in a `statickit.json` file at the root of your project. You can edit it by hand or use the CLI to perform common tasks. Run the following to create a config file, add a contact form, and deploy it.

```bash
statickit init
statickit forms add --key "contact-form" --name "Contact Form"
