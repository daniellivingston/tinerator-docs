...
The `forms` object is where you declare form resources you need for your site.
...
| :------------------------- | :----------------------- | :----------------------------- | :----------------------------------------------------------- |
| `app`                      | String                   | —                             | Must equal `mailchimp`                                       |
| `type`                      | String                  | —                             |  Must equal `addOrUpdateContact`                             |
| `audience`                 | String                   | `@mailchimp-audience`          | Your Mailchimp audience ID                                   |
| `apiKey`                   | String                   | `@mailchimp-api-key`           | The name of the StaticKit secret holding your API key.       |
