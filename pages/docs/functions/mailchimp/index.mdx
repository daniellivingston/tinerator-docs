...
| Type                              | Description                                                  |
| :-------------------------------- | :----------------------------------------------------------- |
| [`addOrUpdateListMember`](/docs/functions/mailchimp/add-or-update-list-member) | Adds or updates a list member |
| [`createEvent`](/docs/functions/mailchimp/create-event) | Adds or updates a contact and tracks an event |
