...
The form component allows you to gather submissions from your website without writing a line of backend code. 

Most other form endpoint services give you a URL to put in the `action` attribute and don't include any JavaScript. **We've intentionally taken a different approach** to offer a superior user experience:
...
At a minimum, you just need a `<form>` element on your page and the following code:
