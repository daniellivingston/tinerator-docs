...
The `form` component allows you to gather submissions from your website without writing a line of backend code. It's as simple as dropping a line of JavaScript on your page to get a full-featured form with:

- Inline-rendered validation errors
- Inline success messages
- Lifecycle hooks to customize behavior
- Spam mitigation

## Getting started

At a minimum, you just need a `<form>` element on your page and an initialize call:
