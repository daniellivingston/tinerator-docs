...
<p className="text-lg">
  In this guide, we'll walk through how to install <a href="https://tailwindcss.com/">Fathom Analytics</a> in a <a href="https://nextjs.org">Next.js</a> project. Fathom is a simple and private website analytics platform&mdash;a great independent alternative to Google Analytics!
</p>
