...
export default withDocs({
  ...
  toc: [
    ...
    [1, "Create a layout & page", "#create-a-page"]
  ],
});
...
Create a basic `webpack.config.js` file in the root of your project. This configuration tells Webpack to look for a `main.js` file in the `src/scripts` directory and to output it into the `_site/assets` directory.
...
<StepHeading step="5" id="create-a-page">Create a layout and page</StepHeading>

Create a `src/_includes/layouts/base.njk` file. This will serve as the base layout for pages on your site:
