...
export default withDocs({
  ...
  toc: [
    ...
    [1, "Create a main script", "#create-a-main-script"],
    [1, "Create a page", "#create-a-page"],
    [1, "Watch for script changes", "#watch-for-script-changes"]
  ],
});
...
<StepHeading step="4" id="create-a-main-script">Create a main script</StepHeading>
...
<StepHeading step="6" id="watch-for-script-changes">Watch for script changes</StepHeading>
