...
export default withDocs({
  ...
  description: 'How to install Tailwind in a Next.js (< v9.2) project.',
  breadcrumbs: [{
    path: '/guides',
    label: 'Guides',
    rel: 'prev'
...
<p className="text-lg">
  ...
  If you are on version 9.2 or above, <a href="/guides/next-js-tailwind">there's an even simpler way!</a>
</p>
...
[Check out the source on GitHub →](https://github.com/statickit-projects/next-js-tailwind/tree/pre-9.2)
