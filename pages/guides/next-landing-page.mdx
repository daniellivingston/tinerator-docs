...
export default withDocs({
  ...
  description: 'How to create a simple landing page to gather email addresses using StaticKit and Next.js.',
  ...
  toc: [
    ...
    [1, "Design your landing page", "#design-your-landing-page"],
    [1, "Create your form", "#create-your-form"],
    [1, "Wire up your landing page", "#wire-up-your-landing-page"],
    [1, "Deploy with ZEIT Now", "#deploy-with-zeit-now"]
  ],
});
...
<h2 id="design-your-landing-page">
...
<h2 id="create-your-form">
  <StepHeading step="3">Create your form</StepHeading>
</h2>
...
<h2 id="wire-up-your-landing-page">
