...
export default withDocs({
  title: 'How To Collect Stripe Payments with React',
  description: 'How to build a React form to collect payments via Stripe.',
  breadcrumbs: [{
    path: '/guides',
    label: 'Guides',
    rel: 'prev'
...
# How To Collect Stripe Payments with React

<p className="text-lg">
  Learn how build a React form to collect <a href="https://stripe.com/">Stripe</a> payments without writing any custom backend code. <a href="https://stripe-react.now.sh">See live examples</a>.
</p>
...
Take a look at our fully styled examples of various payment flows here:

[https://github.com/statickit-projects/stripe-react](https://github.com/statickit-projects/stripe-react)
