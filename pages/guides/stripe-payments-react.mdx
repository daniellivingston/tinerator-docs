...
export default withDocs({
  title: 'How To Build a Stripe Payment Flow Without a Server',
  description: 'Learn how to build React forms to collect payments via Stripe.',
  breadcrumbs: [{
    path: '/guides',
    label: 'Guides',
    rel: 'prev'
...
# How To Build a Stripe Payment Flow Without a Server

<p className="text-lg">
  Learn how build React-based <a href="https://stripe.com/">Stripe</a> flows without writing any custom backend code.
</p>
